...
countries = [["Albania", (25, 37), "AL."], ["Andorra", (23, 14), "And."],
             ["Austria", (19, 30), "AT."], ["Belarus", (13, 42), "Belarus"],
             ["Belgium", (17, 20), "Bel."],
             ["Bosnia and Herzegovina", (22, 33), "BA"],
             ["Bulgaria", (23, 41), "Bulgaria"], ["Croatia", (21, 31), "HR"],
             ["Cyprus", (29, 50),
              "Cyprus"], ["Czech Republic", (17, 29), "CZ"],
             ["Denmark", (11, 22), "Denmark"], ["Estonia", (9, 40), "Estonia"],
             ["Finland", (6, 37), "Finland"], ["France", (20, 11), "France"],
             ["Germany", (15, 24), "Germany"], ["Greece", (27, 38), "Greece"],
             ["Hungary", (19, 36), "HU"], ["Iceland", (3, 10), "Iceland"],
             ["Ireland", (12, 1), "Ireland"], ["Italy", (26, 26), "Italy"],
             ["Kosovo", (23, 36), "Kos."], ["Latvia", (10, 40), "Latvia"],
             ["Liechtenstein", (19, 22), "Liecht."],
             ["Lithuania", (12, 38), "Lithuania"],
             ["Luxembourg", (18, 21), "Lux."], ["Malta", (29, 30), "Malta"],
             ["Moldova", (18, 46), "Moldova"], ["Monaco", (23, 20), "Mon."],
             ["Montenegro", (24, 35), "ME"], ["Netherlands", (14, 21), "NL"],
             ["North Macedonia", (24, 40),
              "MK"], ["Norway", (6, 24), "Norway"],
             ["Poland", (13, 32), "Poland"], ["Portugal", (24, 1), "Portugal"],
             ["Romania", (20, 40), "Romania"], ["Russia", (13, 51), "Russia"],
             ["San Marino", (21, 26), "S.M."], ["Serbia", (22, 37), "Serb."],
             ["Slovakia", (17, 35), "SK."], ["Slovenia", (20, 29), "SL"],
             ["Spain", (26, 5), "Spain"], ["Sweden", (8, 28), "Sweden"],
             ["Switzerland", (20, 20), "Switz."],
             ["Turkey", (25, 48), "Turkey"], ["Ukraine", (16, 44), "Ukraine"],
...
def print_big_number(stdscr, number, offsy, offsx):
    ...
    while len(num_str) != 0:
        ...
        for i in range(0, 6):
            ...
            spacewait = 0
            for char in shorter:
                stdscr.addstr(offsy + i, offsx + num_offsx, shorter,
                              curses.color_pair(3))
            ...
            #spelled country or "quit". Case insensitive
                ...
                if text.lower() == "quit":
                    ...
                    for line in range(0, len(forfeit)):
                        stdscr.addstr(3 + line, 5, forfeit[line][:-5],
                                      curses.color_pair(3))
                    for line in range(0, len(forfeit)):
...
def draw_EU(stdscr, y, x, gfx_add):
    ...
    for item in gfx_add:
        stdscr.addstr(item[0][0], item[0][1] - 1, item[1],
                      curses.color_pair(2))


def check_term_minsize(stdscr, min_h, min_w):
    print("check term minsize")
    while True:
        h, w = stdscr.getmaxyx()
