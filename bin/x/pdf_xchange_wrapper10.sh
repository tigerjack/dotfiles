...
WINEARCH=win64 WINEPREFIX=$MDIR_LINUX_DATA/wine64c wine64 start.exe /Unix "$MDIR_LINUX_DATA/wine64c/dosdevices/c:/Program Files/Tracker Software/PDF Editor/PDFXEdit.exe" "$filename"
